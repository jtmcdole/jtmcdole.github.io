...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1646: () => globalThis.document,
      _1647: () => globalThis.window,
      _1652: (x0,x1) => { x0.height = x1 },
      _1654: (x0,x1) => { x0.width = x1 },
      _1657: x0 => x0.head,
      _1658: x0 => x0.classList,
      _1662: (x0,x1) => { x0.innerText = x1 },
      _1663: x0 => x0.style,
      _1665: x0 => x0.sheet,
      _1676: x0 => x0.offsetX,
      _1677: x0 => x0.offsetY,
